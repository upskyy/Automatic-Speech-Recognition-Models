...
parser.add_argument('--model_path', type=str, default='E:/las_model.pt')
parser.add_argument('--audio_path', type=str, default='E:/speech3.pcm')
parser.add_argument('--label_path', type=str, default='E:/aihub_labels.csv')
